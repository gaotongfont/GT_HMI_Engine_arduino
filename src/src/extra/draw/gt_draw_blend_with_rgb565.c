/**
 * @file gt_draw_blend_with_rgb565.c
 * @author Feyoung
 * @brief
 * @version 0.1
 * @date 2024-06-04 21:31:31
...
static inline void _blend_rgb565_with_opacity_vertical(_gt_draw_blend_fill_cache_st const * const fc) {
...
static inline void _blend_rgb565_with_opacity(_gt_draw_blend_fill_cache_st const * const fc) {
    gt_color_t * src_p = fc->color_src_p;
    gt_opa_t * mask_p = fc->mask_buf_p;
    gt_color_t * dst_p = fc->color_dst_p;
    uint16_t w = fc->area_intersect.w;
...
#if GT_FLUSH_CONVERT_VERTICAL
static inline void _blend_rgb565_with_no_opacity_vertical(_gt_draw_blend_fill_cache_st const * const fc) {
    gt_color_t * src_p = fc->color_src_p;
    gt_color_t * dst_p = fc->color_dst_p;
    uint16_t w = fc->area_intersect.w;
    uint16_t h = fc->area_intersect.h;
...
#else   /** 0 == GT_FLUSH_CONVERT_VERTICAL */
static inline void _blend_rgb565_with_no_opacity(_gt_draw_blend_fill_cache_st const * const fc) {
    gt_color_t * src_p = fc->color_src_p;
    gt_color_t * dst_p = fc->color_dst_p;
    uint16_t w = fc->area_intersect.w;
    uint16_t h = fc->area_intersect.h;
...
{
#if GT_FLUSH_CONVERT_VERTICAL
    return _blend_rgb565_with_opacity_vertical(fc);
#else
    return _blend_rgb565_with_opacity(fc);
#endif
}
...
{
#if GT_FLUSH_CONVERT_VERTICAL
    return _blend_rgb565_with_no_opacity_vertical(fc);
#else
    return _blend_rgb565_with_no_opacity(fc);
#endif
}
